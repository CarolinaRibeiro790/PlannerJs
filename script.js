//bibliotecs e códigos de terceiros para data
...
//arrow function, função é para escrever uma sequencia de código
const criarItemDeAtividade = (atividade) => {

    //ver se a atividade foi finalizada ou não
...
//Data em inglês significa dados, então essa função serve para pegar os dados do formulario; get = pegar
...
const salvarAtividade = (event) => {
    ...
    //antes de salvar na lista, precisa ver se o item já está na lista. find = procura
    ...
    //os ... significa que está dicionando na lista as atividades antigas
...
const criarHorasSelecao = () => {
    ...
    for (let i = 6; i < 23; i++) {
        //padStart preenchimento no inicio
